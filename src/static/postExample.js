...
export const postExample = [
  {
    ...
    mainCategory: "recipe",
    categories: [ "keto", "beef" ],
    imageSrc: "jpg",
    content: `‘Cos Comfort Food Is Awesome! Keto Cottage Pie is another recreation of those previously unhealthy recipes I grew up with.Now revamped into a new healthy version.My resident taste- tester, aka my husband, Carl, declared. “Oo! It’s really nice.What did you do?” And, with such praise, this recipe became a keeper.
    ...
    I don’t recommend this recipe without the cheeses, so for paleo, paleo - ish or whole30, take a look at the Healthy Whole30 Shepherd’s Pie instead.
    So, what's a cottage pie? The British have made an art form out of pies.  If you think of those quintessentially British foods, yes, there is the bangers and mash, fish and chips, but we excel at our pie variety. Who says British food is boring?
